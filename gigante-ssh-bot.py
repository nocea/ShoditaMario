...
#Cogeel archivo dentro de dic "archivoPasswords.txt"#
contrasenas = open("dic/archivoPasswords.txt", "r")
#cad linea es una contraseña#
...
def check_sshBF(ip):
	...
	#a cada p le asigno una contraseña y le quito el salto de linea con .rstrip()#
	...
	if fail == 0:
		...
		print colores.verde + "La password correcta  para acceder es: "+contrasenaValida +colores.normal
		insert_mongodb(ip)
	else:
